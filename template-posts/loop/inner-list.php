<?php 
global $post;
$thumbsize = !isset($thumbsize) ? temp_get_config( 'text_item_thumbsize', 'full' ) : $thumbsize;
$thumb = temp_display_post_thumb($thumbsize);
?>
    ...
    <div class="list-inner <?php echo (!empty($thumb))?'has-thumb':''; ?>">
        <div class="<?php echo (!empty($thumb))?'flex-middle-sm flex':''; ?>">
            ...
            <div class="<?php echo (!empty($thumb))?'col-content':'col-content-full'; ?>">
                ...
                <div class="description hidden-xs hidden-sm"><?php echo temp_substring( get_the_excerpt(),22, '...' ); ?></div>
                <div class="description visible-sm"><?php echo temp_substring( get_the_excerpt(),15, '...' ); ?></div>
